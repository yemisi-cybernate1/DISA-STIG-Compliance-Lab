...
## Objective
This project focuses on assessing system compliance against DISA STIG baselines in a controlled lab environment.  
The goal is to evaluate security posture, identify compliance gaps, and document remediation steps using industry-standard compliance scanning methods.

## Tools Used
- Tenable.io for compliance auditing  
- DISA STIG benchmarks  
- Compliance plugins for STIG assessments  
- Custom scan templates  
- Windows and Linux virtual machines  
- NSG (Network Security Groups)  
- Bastion / SSH / RDP for secure access
...
- Compliance auditing using Tenable.io  
- Use of compliance plugins for security baselines  
- Scan template creation and customization  
- System hardening and remediation  
- Network security using NSGs  
- Secure administrative access (Bastion, SSH, RDP)  
